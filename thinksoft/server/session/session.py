...
from thinksoft.core.config import OpenHandsConfig
...
from thinksoft.core.config.mcp_config import OpenHandsMCPConfigImpl
from thinksoft.core.exceptions import MicroagentValidationError
from thinksoft.core.logger import OpenHandsLoggerAdapter
from thinksoft.core.schema import AgentState
from thinksoft.events.action import MessageAction, NullAction
from thinksoft.events.event import Event, EventSource
from thinksoft.events.observation import (
    AgentStateChangedObservation,
    CmdOutputObservation,
    NullObservation,
)
from thinksoft.events.observation.agent import RecallObservation
...
from thinksoft.server.session.agent_session import AgentSession
...
class WebSession:
    ...
    (see thinksoft.server.session.__init__) so downstream imports/tests continue to
...
# thinksoft.server.session.session import Session
Session = WebSession
