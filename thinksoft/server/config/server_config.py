...
from thinksoft.server.types import AppMode, ServerConfigInterface
...
class ServerConfig(ServerConfigInterface):
    ...
    settings_store_class: str = (
        'thinksoft.storage.settings.file_settings_store.FileSettingsStore'
    )
    secret_store_class: str = (
        'thinksoft.storage.secrets.file_secrets_store.FileSecretsStore'
    )
    conversation_store_class: str = (
        'thinksoft.storage.conversation.file_conversation_store.FileConversationStore'
    )
    ...
    monitoring_listener_class: str = 'thinksoft.server.monitoring.MonitoringListener'
    user_auth_class: str = (
        'thinksoft.server.user_auth.clerk_user_auth.ClerkUserAuth'
    )
