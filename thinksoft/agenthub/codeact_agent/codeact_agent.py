...
if TYPE_CHECKING:
    ...
    from thinksoft.llm.llm import ModelResponse

import thinksoft.agenthub.codeact_agent.function_calling as codeact_function_calling
from thinksoft.agenthub.codeact_agent.tools.bash import create_cmd_run_tool
from thinksoft.agenthub.codeact_agent.tools.browser import BrowserTool
from thinksoft.agenthub.codeact_agent.tools.condensation_request import (
    CondensationRequestTool,
)
from thinksoft.agenthub.codeact_agent.tools.finish import FinishTool
from thinksoft.agenthub.codeact_agent.tools.ipython import IPythonTool
from thinksoft.agenthub.codeact_agent.tools.llm_based_edit import LLMBasedFileEditTool
from thinksoft.agenthub.codeact_agent.tools.str_replace_editor import (
    create_str_replace_editor_tool,
)
from thinksoft.agenthub.codeact_agent.tools.task_tracker import (
    create_task_tracker_tool,
)
from thinksoft.agenthub.codeact_agent.tools.think import ThinkTool
from thinksoft.controller.agent import Agent
from thinksoft.controller.state.state import State
from thinksoft.core.config import AgentConfig
from thinksoft.core.logger import openhands_logger as logger
from thinksoft.core.message import Message
from thinksoft.events.action import AgentFinishAction, MessageAction
from thinksoft.events.event import Event
from thinksoft.llm.llm_utils import check_tools
from thinksoft.memory.condenser import Condenser
...
from thinksoft.runtime.plugins import (
