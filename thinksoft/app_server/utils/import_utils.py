...
def import_from(qual_name: str):
    ...
    'thinksoft.server.user_auth.UserAuth' would import the UserAuth class from the
    thinksoft.server.user_auth module.
...
def get_impl(cls: type[T], impl_name: str | None) -> type[T]:
    ...
    Args:
        ...
        impl_name: Fully qualified name of the implementation class, or None to use
                  the base class
                  e.g. 'thinksoft.server.conversation_service.'
