...
from thinksoft.integrations.azure_devops.service.branches import (
    AzureDevOpsBranchesMixin,
)
from thinksoft.integrations.azure_devops.service.features import (
    AzureDevOpsFeaturesMixin,
)
from thinksoft.integrations.azure_devops.service.prs import AzureDevOpsPRsMixin
from thinksoft.integrations.azure_devops.service.repos import AzureDevOpsReposMixin
from thinksoft.integrations.azure_devops.service.resolver import (
    AzureDevOpsResolverMixin,
)
from thinksoft.integrations.azure_devops.service.work_items import (
    AzureDevOpsWorkItemsMixin,
)
from thinksoft.integrations.protocols.http_client import HTTPClient
...
azure_devops_service_cls = os.environ.get(
    ...
    'thinksoft.integrations.azure_devops.azure_devops_service.AzureDevOpsService',
)
