...
from thinksoft.integrations.github.queries import (
    search_branches_graphql_query,
)
from thinksoft.integrations.github.service.base import GitHubMixinBase
from thinksoft.integrations.service_types import Branch, PaginatedBranchesResponse
