...
from thinksoft.core.config.condenser_config import ConversationWindowCondenserConfig
...
from thinksoft.memory.condenser.condenser import Condensation, RollingCondenser, View
