...
from thinksoft.events.serialization import event_to_dict, observation_from_dict
...
from thinksoft.runtime.utils.request import send_request
from thinksoft.runtime.utils.system_stats import update_last_execution_time
from thinksoft.utils.http_session import HttpSession
...
class ActionExecutionClient(Runtime):
    ...
    async def call_tool_mcp(self, action: MCPAction) -> Observation:
        ...
        from thinksoft.mcp.utils import call_tool_mcp as call_tool_mcp_handler
