...
from thinksoft.core.exceptions import BrowserUnavailableException
from thinksoft.core.logger import get_uvicorn_json_log_config
...
from thinksoft.events.serialization import event_from_dict, event_to_dict
from thinksoft.runtime.browser import browse
from thinksoft.runtime.browser.browser_env import BrowserEnv
from thinksoft.runtime.file_viewer_server import start_file_viewer_server

# Import our custom MCP Proxy Manager
from thinksoft.runtime.mcp.proxy import MCPProxyManager
from thinksoft.runtime.plugins import ALL_PLUGINS, JupyterPlugin, Plugin, VSCodePlugin
from thinksoft.runtime.utils import find_available_tcp_port
from thinksoft.runtime.utils.bash import BashSession
from thinksoft.runtime.utils.files import insert_lines, read_lines
from thinksoft.runtime.utils.memory_monitor import MemoryMonitor
from thinksoft.runtime.utils.runtime_init import init_user_and_working_directory
from thinksoft.runtime.utils.system_stats import (
    get_system_stats,
...
if sys.platform == 'win32':
    from thinksoft.runtime.utils.windows_bash import WindowsPowershellSession
    ...
    async def ainit(self):
        ...
        if 'agent_skills' in self.plugins and 'jupyter' in self.plugins:
            obs = await self.run_ipython(
                IPythonRunCellAction(
                    code='from thinksoft.runtime.plugins.agent_skills.agentskills import *\n'
                )
            )
