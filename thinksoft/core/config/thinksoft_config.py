...
class ThinksoftConfig(BaseModel):
    ...
    def model_post_init(self, __context: Any) -> None:
        ...
        if not ThinksoftConfig.defaults_dict:  # Only set defaults_dict if it's empty
            ThinksoftConfig.defaults_dict = model_defaults_to_dict(self)
