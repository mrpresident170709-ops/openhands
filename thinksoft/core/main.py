...
from thinksoft.core.config.mcp_config import ThinksoftMCPConfigImpl
from thinksoft.core.logger import thinksoft_logger as logger
from thinksoft.core.loop import run_agent_until_done
from thinksoft.core.schema import AgentState
from thinksoft.core.setup import (
    create_agent,
    create_controller,
    create_memory,
    create_runtime,
...
from thinksoft.events import EventSource, EventStreamSubscriber
...
from thinksoft.io import read_input, read_task
...
async def run_controller(
    ...
    if agent.config.enable_mcp:
        ...
        _, openhands_mcp_stdio_servers = (
            ThinksoftMCPConfigImpl.create_default_mcp_server_config(
...
if __name__ == '__main__':
    ...
    config: ThinksoftConfig = setup_config_from_args(args)
